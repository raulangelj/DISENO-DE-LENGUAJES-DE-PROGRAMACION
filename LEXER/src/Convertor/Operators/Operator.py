from src.Convertor.Operators.Constants import OPEN_AGRUPATION_SIMBOL, CLOSE_AGRUPATION_SIMBOL, EMPTY_SIMBOL, CONCATENATION_SIMBOL, KLEENE_SIMBOL, UNION_SIMBOL, OPTIONAL_SIMBOL, PLUS_SIMBOL
